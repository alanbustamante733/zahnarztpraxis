...
@WebServlet(name = "SvZahnarzt", urlPatterns = {"/SvZahnarzt"})
public class SvZahnarzt extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        meineSessionZahnarzt.setAttribute("zahnaerzteListe", zahnaerzteListe);
        
        response.sendRedirect("ZahnaerzteAnzeigen.jsp");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            control.zahnarztErstellen(ausweisnummer, name, nachname, telefon, adresse, fachrichtung, geburtsdatum);
